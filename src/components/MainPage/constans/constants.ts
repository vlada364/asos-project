export const womenCategoriesRow = [
    ...
    },
    {
        ...
        title: 'ASOS DESIGN UTILITY',
        paragraph: 'Pocket picks'
    },{
        img: 'https://content.asos-media.com/-/media/homepages/ww/2023/february/27-prime/moments/app_hero_balletcore_ww_1_870-x-1110.jpg',
        title: 'BALLETCORE',
        paragraph: 'Barre-raising looks'
    },{
        img: 'https://content.asos-media.com/-/media/homepages/ww/2023/february/27-prime/moments/wwglobalfbinkylistmoment870x1110.jpg',
 ...
 export const womenTwoBigImage=[
     {img:'https://content.asos-media.com/-/media/homepages/ww/2023/march/10-prime/50percent_moment_870x1110-(2).jpg',
         ...
         img:'https://content.asos-media.com/-/media/homepages/ww/2023/february/27-prime/moments/ww_global_miss_selfridge_moment_870x1110.jpg',
         title:'NEW MISS SELFRIDGE',
         paragraph: 'Spring essentials',
...
export const menTwoBigImage=[
    {img:'https://content.asos-media.com/-/media/homepages/mw/2023/february/27-prime/moments/mw_global_wedding_moment_870x1110.jpg',
        ...
        img:'https://content.asos-media.com/-/media/homepages/mw/2023/march/6-prime-uk-only/mw_global_summer_grunge_moment_870x1110.jpg',
        title:'NEW IN TREND',
        paragraph: 'Going grunge',
        btnText: 'SHOP ASOS DESIGN'
    }
]
export const menCategoriesRow=[
    ...
    },
    {
        ...
        title: 'NEW BALANCE',
        paragraph: `Can't beat a classic`
    },{
        img: 'https://content.asos-media.com/-/media/homepages/mw/2023/february/27-prime/moments/mw_global_sunnies_moment_870x1110.jpg',
        title: 'SUUNNIES',
        paragraph: 'The shade of it all'
    },{
        img: 'https://content.asos-media.com/-/media/homepages/mw/2023/february/27-prime/moments/mw_global_asos_design_denim_moment_870x1110v2.png',
        title: 'ASOS DESIGN DENIM',
        paragraph: 'The jean scene'
    }]
